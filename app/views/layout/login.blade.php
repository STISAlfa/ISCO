...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		{{ Form::open(array('url' => 'login','class'=>'form-vertical login-form','id'=>'login-form')) }}
			...
			<div class="alert alert-danger">
				...
				<span>Login Gagal. Pastikan Username dan Password kamu Benar serta akun kamu sudah terverifikasi</span>
			</div>
			@endif
			...
			<div class="alert alert-error hide">
				<button class="close" data-dismiss="alert"></button>
				<span>Masukkan Password dan Username.</span>
			</div>
			...
			<div class="sign-up">
				...
				<p>
					klik <a href="register"  id="forget-password">disini</a>
					untuk mendaftar.
				</p>
			</div>
		</form>
